                ...
                for minibatch_index in range(n_train_batches):
                    ...
                    if (iteration + 1) % validation_frequency == 0:
                        ...
                        if valid_loss <= best_validation_loss:
                            ...
                            model.save(self.output_directory+'best_model.keras')

                        model.save(self.output_directory + 'last_model.keras')
...
#         fully_connected = keras.layers.Dense(units=256, activation='sigmoid', 
#             kernel_initializer='glorot_uniform')(concat_layer)
        ...
        for pool_factor in self.pool_factors:
            for filter_size in self.filter_sizes:
                ...
                if (valid_loss < best_valid_loss): 
                    ...
                    model.save(output_directory_root+'best_model.keras')
